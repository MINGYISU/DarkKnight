...
int main()
{
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        if(playerChoice == "Shade"){
            ...
            Player *player = new Goblin(w.picture(), xCorPlayer, yCorPlayer);
        }else if(playerChoice == "Drow"){
            Player *player = new Drow(w.picture(), xCorPlayer, yCorPlayer);
        }else if(playerChoice == "Troll"){
            Player *player = new Troll(w.picture(), xCorPlayer, yCorPlayer);
        }else{
        ...
        //generate the enemy
        string arrEnemyName[6] = {"Human", "Halfling", "Elf", "Orcs", "Merchant", "Dwarf"};
